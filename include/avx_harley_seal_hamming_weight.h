...
// compute the Hamming weight of an array of 64-bit words using AVX2 instructions and Harley Seal (version using a particular optimization proposed by Kim Walisch)
